...
local L = LibStub("AceLocale-3.0"):GetLocale("DefaultUI_DeathKnight")
local GetWoWVersion = ((select(4, GetBuildInfo())))
--local texturepackCheck    = "1.0.1.7"
--local texturepackDate     = "26/11/20"
local f = CreateFrame("Frame", "DefaultUI_DeathKnight_Config", UIParent)
f:SetSize(50, 50)
f:RegisterEvent("PLAYER_LOGIN")
f:SetScript("OnEvent", function(self, event, ...)
  character = UnitName("player").."-"..GetRealmName()
  -- Config/Panel
  if not DefaultUI_DeathKnight_Config then
    local DefaultUI_DeathKnight_Config = {}
  end
  -- Color Init
...
local dialogFrameTexture 		= "Interface\\Addons\\DefaultUI_DeathKnight\\textures\\extra\\dialogFrameTexture"
...
BasicFrames:SetScript("OnEvent", function(self, event, addon)
	if (addon == "DefaultUI_DeathKnight") then
		for i, v in pairs({	
			PlayerFrameTexture,
...
AbyssUISave:SetScript("OnEvent", function(self, event, arg1)
	if (event == "ADDON_LOADED" and arg1 == "DefaultUI_DeathKnight") then
